...
module.exports = {
  ...
  actions: (data) => {
    ...
    const actions = [{
      type: 'add',
      path: '../../app/forms/formFields/{{properCase name}}/index.js',
      templateFile: componentTemplate,
      abortOnFail: true,
    }, {
      type: 'add',
      path: '../../app/forms/formFields/{{properCase name}}/tests/index.test.js',
      templateFile: './formField/test.js.hbs',
      abortOnFail: true,
    }, {
      type: 'add',
      path: '../../app/forms/formFields/{{properCase name}}/style.scss',
      templateFile: './formField/style.scss.hbs',
      abortOnFail: true,
    }, {
      type: 'add',
      path: '../../app/forms/formFields/{{properCase name}}/stories/index.story.js',
