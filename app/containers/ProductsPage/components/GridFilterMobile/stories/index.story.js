...
storiesOf(componentPath, module)
  .add('Normal state',
    withInfo('Notes for Normal state')(
      () => (
        <GridFilter changeFilter={action('changeFilter')} optionsAvailability={optionsAvailability} optionsbase={optionsbase} optionsperiod={optionsperiod} productFilter={productFilter} />
      )
    )
  );
